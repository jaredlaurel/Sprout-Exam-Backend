...
async def create_employee(
    ...
    employee_manager: EmployeeManager = Depends(EmployeeManagerContext.get_employee_manager),
) -> ResponseModel:
...
async def get_employee_by_id(
    ...
    if employee:
        return employee
    raise NotFoundException(f"Employee with id:{employee_id} not found")  # pragma: no cover
...
async def update_employee(
    ...
    if employee_updated:
        return ResponseModel(
            **{"id": employee_id, "success": True, "message": "Employee successfully updated."}
        )
...
async def remove_employee(
    ...
    if employee_removed:
        return ResponseModel(
            **{"id": employee_id, "success": True, "message": "Employee successfully deleted."}
        )
